...
function createCylinderFromEnds( material, radiusTop, radiusBottom, top, bottom, segmentsWidth, openEnded)
{
    ...
    var cyl = new THREE.Mesh(
        new THREE.CylinderGeometry(radiusTop, radiusBottom, length, segmentsWidth, 1, openEnded),
        material);
...
cylAxis.normalize();
	...
	geo.vertices.push(rotationAxis.clone().multiplyScalar(10000));
	...
	var theta = -Math.PI/90; // -Math.acos( cylAxis.dot( yAxis ) );
...
function fillScene() {
    ...
    addNewMesh(drawTriangle(0, 0, 10, 10));
